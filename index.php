...
<body>
    <header>
        <div class="head-top">
            <a class="logo-link" href="#">
                ...
                <span class="text-logo">Privacy e termini</span>
            </a>
        </div>
        ...
        <div class="head-bottom">
            <nav>
                <ul>
                    <?php
                    foreach ($navLink as $singoloLink) {
                        echo "<li>";
                        echo '<a href="#">' . $singoloLink . '</a>';
                        echo "</li>";
                    }
                    ?>
                </ul>
    ...
    <main>
        <div class="container">
            <?php
            foreach ($database as $singolaDomanda) {
                echo '<div class="singola-domanda">';
                echo "<h2>" . $singolaDomanda["title"] . "</h2>";
                //var_dump($singolaDomanda);
                $elencoParagrafi = $singolaDomanda["paragraphs"];
                //var_dump($elencoParagrafi);
                foreach ($elencoParagrafi as $singoloParagrafo) {
                    echo "<p>" . $singoloParagrafo . "</p>";
                }
                echo "</div>";
            };
            ?>
